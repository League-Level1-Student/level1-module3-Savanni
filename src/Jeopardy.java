...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		JPanel headerthing = createHeader("Questions");
		// 4. Add the header component to the quizPanel
		quizPanel.add(headerthing);
	...
	public void actionPerformed(ActionEvent e) {
		...
		// Call the askQuestion() method
			askQuestion("Why live?", "Memes", 200);
		}
		...
		// Call the askQuestion() method with a harder question
			askQuestion("What is the best pokemon", "Raichu", 400);
		...
		if(buttonPressed.equals(thirdButton)) {
			askQuestion("What is love?", "Baby don't hurt me", 600);
		}
	}
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		// answer
			JOptionPane.showMessageDialog(null, "I'm sorry! That's wrong.");
